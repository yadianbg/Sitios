...
urlpatterns = [
    ...
    re_path('tipo/(?P<pk>[0-9a-f]{32})', tipo.detailsTipoSitio.as_view(), name='tipoSitio_details'),
    ...
    re_path('provincia/(?P<pk>[0-9a-f]{32})', provincia.detailsProvincia.as_view(), name='provincia_details'),
    ...
    re_path('sitio/(?P<pk>[0-9a-f]{32})', sitio.detailsSitio.as_view(), name='sitio_details'),
